...
public class Graficador : GameWindow
{
    ...
    public void CrearObjeto()
    {
        ...
        cuboh.trasladar(centroh);
        cubov.trasladar(centrov);

        Punto centroob = new Punto(0.5f, 0.5f, 0.0f);
        C = new Objeto();
        C.agregar("cuboh", cuboh);
        C.agregar("cubov", cubov);
        T = archivar.deserializarobjeto("T");
        T.trasladar(centroob);
        Objeto Q = new Objeto();
        Q = archivar.deserializarobjeto("T");
        Q.trasladar(new Punto(-0.5f, -0.5f, 0));
        C.obtener("cuboh").Escalar(2);
        //T.Centro = new Punto(0.5f, 0.2f, 0);
        //C.Escalar(2);
        //T.Escalar(2);
        //T.trasladar(new Punto());
        //T.Escalar(0.5f);
        escenario.agregar("T1", T);
        escenario.agregar("T2", C);
        escenario.agregar("T3", Q);
        //escenario.Escalar(2);
        //escenario.Trasladar(centroob);
        //escenario.Rotar(90f, 0f, 0f);
        //escenario.trasladar(new Punto(0.1f, 0.1f, 0.0f));
        //escenario.Escalar(0.5f);
    ...
    protected override void OnRenderFrame(FrameEventArgs e)
    {
        ...
        plano.Dibujar();
        escenario.Dibujar();
        //escenario.obtener("T1").Rotar(1, 0, 0);
        //escenario.Trasladar(new Punto(0.001f,0,0));
        //escenario.obtener("T2").Rotar(1, 0, 0);
        //T.Dibujar();
        //C.Dibujar();
        //T.Rotar(1, 0, 0);
        //C.Rotar(1, 0, 0);
