...
namespace Tarea3
{
    public class Graficador : GameWindow
    {
        ...
        public void CrearObjeto()
        {
            ...
            Punto p5h = new Punto(-0.2f, -0.1f, 0.3f);
            Punto p6h = new Punto(0.2f, -0.1f, 0.3f);
            Punto p7h = new Punto(0.2f, 0.1f, 0.3f);
            Punto p8h = new Punto(-0.2f, 0.1f, 0.3f);
            ...
            Punto p5v = new Punto(-0.1f, -0.2f, 0.3f);
            Punto p6v = new Punto(0.1f, -0.2f, 0.3f);
            Punto p7v = new Punto(0.1f, 0.2f, 0.3f);
            Punto p8v = new Punto(-0.1f, 0.2f, 0.3f);
            ...
            Punto centroob = new Punto(0.1f,0.1f,0.0f);
            Objeto T = new Objeto();
